...
namespace Nop.Services.Media.RoxyFileman
{
    ...
    public class FileRoxyFilemanService : BaseRoxyFilemanService, IRoxyFilemanService
    {
        ...
        public FileRoxyFilemanService(IWebHostEnvironment webHostEnvironment,
            ...
            ILogger logger) : base(webHostEnvironment, httpContextAccessor, fileProvider, webHelper, workContext, mediaSettings)
        {
            _fileRootPath = null;
            _logger = logger;
        }
        ...
        public virtual async Task DeleteFileAsync(string path)
        {
            ...
            // CUSTOM: this exception is eaten, want to bubble it out
            catch (Exception e)
            {
                _logger.InsertLog(LogLevel.Error, "Error occurred deleting file from Roxy Fileman.", e.Message);
