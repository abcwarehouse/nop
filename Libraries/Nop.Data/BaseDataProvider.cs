...
namespace Nop.Data
{
    public abstract class BaseDataProvider
    {
        ...
        public T ExecuteStoredProcedure<T>(string procedureName, int timeout = 0, params DataParameter[] parameters)
        {
            using var dataContext = CreateDataConnection(timeout);
        ...
        /// <param name="parameters">Command parameters</param>
        /// <returns>Number of records, affected by command execution.</returns>
        public int ExecuteStoredProcedure(string procedureName, int timeout = 0, params DataParameter[] parameters)
        {
            using var dataContext = CreateDataConnection(timeout);
            var command = new CommandInfo(dataContext, procedureName, parameters);
