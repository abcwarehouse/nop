...
namespace Nop.Data
{
    ...
    public partial interface INopDataProvider
    {
        ...
        // CUSTOM: added timeout
        T ExecuteStoredProcedure<T>(string procedureName, int timeout = 0, params DataParameter[] parameters);
        ...
        /// <returns>Returns collection of query result records</returns>
        // CUSTOM: added timeout
        int ExecuteStoredProcedure(string procedureName, int timeout = 0, params DataParameter[] parameters);
