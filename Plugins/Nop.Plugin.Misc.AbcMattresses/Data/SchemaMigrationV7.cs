...
namespace Nop.Plugin.Misc.AbcCore.Data
{
    ...
    public class SchemaMigrationV7 : AutoReversingMigration
    {
        ...
        {
            Create.Table(nameof(AbcMattressModelFrameMapping))
                .WithColumn(nameof(AbcMattressModelFrameMapping.Id)).AsInt32().NotNullable().PrimaryKey().Identity()
                .WithColumn(nameof(AbcMattressModelFrameMapping.AbcMattressModelId))
                    .AsInt32()
                    .ForeignKey(nameof(AbcMattressModel), nameof(AbcMattressModel.Id))
                    .OnDelete(Rule.Cascade)
                .WithColumn(nameof(AbcMattressModelFrameMapping.AbcMattressFrameId))
                    .AsInt32()
