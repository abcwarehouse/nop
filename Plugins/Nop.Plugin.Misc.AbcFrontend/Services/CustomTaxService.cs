    ...
    public class CustomTaxService : TaxService, ICustomTaxService
    {
        ...
        public bool IsCustomerInTaxableState(int taxCategoryId, Customer customer)
        {
            ...
            var activeTaxProvider =
                _taxPluginManager.LoadPrimaryPlugin(customer, _storeContext.CurrentStore.Id);
            ...
            if (activeTaxProvider != null && shippingAddress != null)
            {
                ...
                var tp = new CountryStateZipTaxProvider(_taxRateService, _storeContext,
                    ...
                    _cacheKeyService, _countryService, _httpContextAccessor,
