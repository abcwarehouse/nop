...
namespace Nop.Plugin.Misc.AbcCore.Services
{
    ...
    public class FrontEndService
    {
        ...
        {
            return _staticCacheManager.Get(new CacheKey(THEMENAME_KEY, "Abc."), () =>
            {
        ...
        public string GetNonClearanceUrl(int currentStoreId)
        {
            return _staticCacheManager.Get(new CacheKey(NONCLEARANCEURL_KEY, "Abc."), () =>
            {
                var storeList = EngineContext.Current.Resolve<IStoreService>().GetAllStores().ToList();
