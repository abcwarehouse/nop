...
namespace Nop.Plugin.Misc.AbcCore.Services
{
    public class CustomShopService : ShopService, ICustomShopService
    {
        ...
        public CustomShopService(
            ...
            ) : base(shopImageRepository, shopRepository, urlRecordRepository, staticCacheManager,
                     entitySettingService, eventPublisher, storeContext, storeMappingService,
                     webHelper, workContext, storeLocatorSettings, customerService, cacheKeyService)
        {
