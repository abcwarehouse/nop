...
namespace Nop.Plugin.Misc.AbcCore
{
    ...
    public static class HtmlHelpers
    {
        ...
        public static string GetPavilionPrimaryColor()
        {
            var staticCacheManager = EngineContext.Current.Resolve<IStaticCacheManager>();
            return staticCacheManager.Get(new CacheKey(PAVILIONPRIMARYCOLOR_KEY, "Abc."), () =>
            {
                string preset = EngineContext.Current.Resolve<ISettingService>().GetSettingByKey<string>("pavilionthemesettings.preset");
        ...
        {
            var staticCacheManager = EngineContext.Current.Resolve<IStaticCacheManager>();
            return staticCacheManager.Get(new CacheKey(PAVILIONACCENTCOLOR_KEY, "Abc."), () =>
            {
                string preset = EngineContext.Current.Resolve<ISettingService>().GetSettingByKey<string>("pavilionthemesettings.preset");
                var presetParts = preset.Split(',');
