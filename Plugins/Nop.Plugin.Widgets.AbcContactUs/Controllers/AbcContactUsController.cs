...
namespace Nop.Plugin.Widgets.AbcHomeDeliveryStatus.Controllers
{
    public class AbcContactUsController : BasePluginController
    {
        ...
        public IActionResult Configure(ContactUsConfigModel model)
        {
            _settingService.SaveSetting(ContactUsWidgetSettings.FromModel(model));
        ...
        [HttpPost]
        public IActionResult DisplayContactUs(ContactUsModel model)
        {
