...
namespace Nop.Plugin.Widgets.AbcBonusBundle.Components
{
    public class WidgetsAbcEnergyGuideViewComponent : NopViewComponent
    {
        ...
        public IViewComponentResult Invoke(string widgetZone, TabUIModel additionalData = null)
        {
            if (additionalData == null)
            {
                _logger.Error("Widgets.AbcEnergyGuide: TabUIModel not passed to ViewComponent, skipping display.");
                return Content("");
            }
