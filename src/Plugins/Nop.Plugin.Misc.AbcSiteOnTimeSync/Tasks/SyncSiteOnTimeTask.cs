...
namespace Nop.Plugin.Misc.AbcSiteOnTimeSync
{
    public class SyncSiteOnTimeTask : IScheduleTask
    {
        ...
        public async System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            await _logger.InformationAsync("Site on Time sync started");
            ...
            Debug.WriteLine("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
            Debug.WriteLine("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
            await _logger.InformationAsync("Site on Time sync completed");
        }
        ...
        private void main()
        {
            ...
            var command = $@"
                    ...
                    SET @BRANDS = '70  ,85  ,95  ,191 ,267 ,651 ,2452'
                    SET @BRDFRI = '85  ,95  ,191 ,267 ,651 ,2452'   /***   No Fridigdaire****/
