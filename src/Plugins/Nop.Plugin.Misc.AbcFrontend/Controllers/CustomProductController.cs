    ...
    public partial class CustomProductController : BasePublicController
    {
        ...
        public virtual IActionResult NewProductsRss()
        {
            var feed = new RssFeed(
                $"{_localizationService.GetLocalized(await _storeContext.GetCurrentStoreAsync(), x => x.Name)}: New products",
        ...
        public virtual IActionResult ProductReviews(int productId)
        {
            ...
            {
                var hasCompletedOrders = _orderService.SearchOrders(customerId: await _workContext.GetCurrentCustomerAsync().Id,
                    productId: productId,
