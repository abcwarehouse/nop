...
namespace Nop.Plugin.Misc.AbcFrontend.Controllers
{
    public partial class CustomShoppingCartController : BasePublicController
    {
        ...
        protected virtual void ParseAndSaveCheckoutAttributes(IList<ShoppingCartItem> cart, IFormCollection form)
        {
            ...
            var checkoutAttributes = _checkoutAttributeService.GetAllCheckoutAttributes((await _storeContext.GetCurrentStoreAsync()).Id, excludeShippableAttributes);
            ...
            _genericAttributeService.SaveAttribute(await _workContext.GetCurrentCustomerAsync(), NopCustomerDefaults.CheckoutAttributes, attributesXml, (await _storeContext.GetCurrentStoreAsync()).Id);
        }
            ...
            int quantity, bool forceredirection = false)
        {
            ...
            addToCartWarnings = _shoppingCartService.AddToCart(customer: await _workContext.GetCurrentCustomerAsync(),
                product: product,
            ...
            bool loadPicture, IFormCollection form)
        {
            ...
            if (_permissionService.Authorize(StandardPermissionProvider.DisplayPrices) && !product.CustomerEntersPrice)
            {
                ...
                var finalPrice = _shoppingCartService.GetUnitPriceAsync(product,
                    await _workContext.GetCurrentCustomerAsync(),
                    ShoppingCartType.ShoppingCart,
                    1, attributeXml, 0,
        ...
        public virtual IActionResult CheckoutAttributeChange(IFormCollection form, bool isEditable)
        {
            ...
            var attributeXml = _genericAttributeService.GetAttribute<string>(await _workContext.GetCurrentCustomerAsync(),
            ...
            var excludeShippableAttributes = !_shoppingCartService.ShoppingCartRequiresShipping(cart);
            var attributes = _checkoutAttributeService.GetAllCheckoutAttributes((await _storeContext.GetCurrentStoreAsync()).Id, excludeShippableAttributes);
            foreach (var attribute in attributes)
            {
        ...
        public virtual IActionResult UpdateCart(IFormCollection form)
        {
            ...
            var warnings = orderedCart.Select(cartItem => new
            {
                ...
                Warnings = await _shoppingCartService.UpdateShoppingCartItem(await _workContext.GetCurrentCustomerAsync(),
        ...
        public virtual IActionResult StartCheckout(IFormCollection form)
        {
            ...
            //validate attributes
            var checkoutAttributes = _genericAttributeService.GetAttribute<string>(await _workContext.GetCurrentCustomerAsync(),
                NopCustomerDefaults.CheckoutAttributes, (await _storeContext.GetCurrentStoreAsync()).Id);
            ...
            if (anonymousPermissed || !_customerService.IsGuest(await _workContext.GetCurrentCustomerAsync()))
        ...
        public virtual IActionResult ApplyDiscountCoupon(string discountcouponcode, IFormCollection form)
        {
            ...
            if (!string.IsNullOrWhiteSpace(discountcouponcode))
            {
                ...
                if (discounts.Any())
                {
                    ...
                    {
                        var validationResult = _discountService.ValidateDiscount(discount, await _workContext.GetCurrentCustomerAsync(), new[] { discountcouponcode });
                    ...
                    {
                        //valid
                        _customerService.ApplyDiscountCouponCode(await _workContext.GetCurrentCustomerAsync(), discountcouponcode);
        ...
        public virtual IActionResult ApplyGiftCard(string giftcardcouponcode, IFormCollection form)
        {
            ...
            if (!_shoppingCartService.ShoppingCartIsRecurring(cart))
            {
                if (!string.IsNullOrWhiteSpace(giftcardcouponcode))
                {
                    ...
                    if (isGiftCardValid)
                    {
                        _customerService.ApplyGiftCardCouponCode(await _workContext.GetCurrentCustomerAsync(), giftcardcouponcode);
        ...
        public virtual IActionResult RemoveDiscountCoupon(IFormCollection form)
        {
            ...
            if (discount != null)
                _customerService.RemoveDiscountCouponCode(await _workContext.GetCurrentCustomerAsync(), discount.CouponCode);
        ...
        public ActionResult EmailWishlistSend(WishlistEmailAFriendModel model, bool captchaValid)
        {
            ...
            if (_customerService.IsGuest(await _workContext.GetCurrentCustomerAsync()) && !_shoppingCartSettings.AllowAnonymousUsersToEmailWishlist)
            {
            ...
            {
                //email
                _workflowMessageService.SendWishlistEmailAFriendMessage(await _workContext.GetCurrentCustomerAsync(),
